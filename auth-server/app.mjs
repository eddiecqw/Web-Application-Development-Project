...
app.use(
  cors({
    ...
    origin: ['http://localhost:5173','https://web-application-development-project-rfmutz8st.vercel.app','https://web-application-development-project-nq0r4b54q.vercel.app'],
    methods: ['GET', 'POST'],
